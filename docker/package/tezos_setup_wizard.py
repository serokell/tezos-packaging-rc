...
service_mode_query = Step(
    ...
    "When this option is chosen, this wizard will help you bootstrap octez-node only.",
    options=modes,
...
liquidity_toggle_vote_query = Step(
    ...
    "https://tezos.gitlab.io/kathmandu/liquidity_baking.html",
...
def get_snapshot_mode_query(modes):
    return Step(
        ...
        help="A fully-synced local octez-node is required for running a baking instance.\n"
        "By default, service with octez-node will start to bootstrap from scratch,\n"
        ...
        "that is sufficient for baking. You can read more about other octez-node history modes here:\n"
...
snapshot_file_query = Step(
    id="snapshot_file",
    prompt="Provide the path to the octez-node snapshot file.",
...
snapshot_url_query = Step(
    id="snapshot_url",
    prompt="Provide the url of the octez-node snapshot file.",
...
history_mode_query = Step(
    ...
    help="History modes govern how much data octez-node stores, and, consequently, how much disk\n"
    "space is required. Rolling mode is the smallest and fastest but still sufficient for baking.\n"
    "You can read more about different octez-node history modes here:\n"
